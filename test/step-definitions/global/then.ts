...
import checkValidateText from "../../support/check/checkValidateText";
import isDisable from "../../support/check/isDisable";
...
Then(/^I expect that element "([^"]*)?" is disabled$/, isDisable);
...
Then(/^I expect that a text "(.+)" on this page$/, checkValidateText);
